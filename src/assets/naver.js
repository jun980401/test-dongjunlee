/*!
 * NAVER Maps API v3 - 3.8.2 - 2024-07-18
 *
 * Copyright(c) 2024, NAVER corp, Team mantle
 */
!(function (t, e) {
  function i() {
  ...
  var r = '',
    ...
    u = null,
    p = null,
    d = /(o|open)api\.map\.naver\.com\/openapi\/v3\/maps\.js\b/,
    f = (t.location.href + '').replace(/\s+/g, '');
  !(function () {
    for (
      var t = n.getElementsByTagName('script'), e = '', i = t.length - 1;
      i >= 0 && ((e = t[i].src || ''), !d.test(e));
      i--
    )
      e = '';
    ...
    _ = function (e) {
      if (e instanceof o.Map != !1) {
        ...
        var s = new Date().getTime(),
          p =
            (R ? 'https' : 'http') +
            '://oapi.map.naver.com/v1/validatev3' +
            (a ? '?clientId=' + a : '') +
            (h ? '?ncpClientId=' + h : '') +
            (l ? '?govClientId=' + l : '') +
            (c ? '?finClientId=' + c : '') +
        ...
        g
          ...
          : (o.jsonp(p, {
              callback: function (t) {
                if (t && t.result) lt--, (ht = !0), (ct.length = 0);
                else {
                  if (t.error) {
  ...
  var m,
    ...
    rt = 'Feature',
    at = 'FeatureCollection',
    ht = !1,
    lt = 0,
    ct = [],
    ut = null,
    pt = function () {
      t.navermap_authFailure &&
        'function' == typeof t.navermap_authFailure &&
        t.navermap_authFailure();
    },
    dt = function () {
      if (0 !== ct.length) {
        for (var e = 0, i = ct.length; e < i; e++) ct[e]();
        (ct.length = 0),
          t.clearTimeout(ut),
          (ut = t.setTimeout(function () {
    ...
    Tt = function (t) {
      ...
      return t && i.push(e + 'dbasic' + gt + '.json?fmt=png'), i;
    },
    xt = [
      'bg',
      'ol',
    ...
    Pt = {
      TRY_AGAIN_CONTROL: [
        ...
        '\u25a0 Web Dynamic Map \ub9f5 \ud0c0\uc77c \uad6c\ubc84\uc804\uc5d0\uc11c \uc2e0\ubc84\uc804\uc73c\ub85c \uc804\ud658\ud558\uae30(https://navermaps.github.io/maps.js.ncp/docs/tutorial-StyleMap-1.html)',
      ],
      TRY_AGAIN_LAYER: [
  ...
  (o.TILE_TYPES = mt),
    (o.GET_STYLE_MAP_METADATA_URLS = Tt),
    (o.SSL = R),
    (o.IS_IN_HOUSE = !1);
  var Ot = t.console || {
      info: function (t) {},
    ...
    Ct = {
      ...
      extend: function (t) {
        var e,
          ...
          n = !1;
        for (
          'boolean' == typeof t && ((n = t), (t = arguments[1])), i = 1;
          i < arguments.length;
          i++
        )
          (e = arguments[i]),
            Ct.forEach(e, function (e, i) {
              switch (typeof e) {
                case 'object':
                  n && e
                    ? e.clone
  ...
  Ct.extend(o, Ct),
    (Ct.BLANK_IMAGE = F),
    (o.calcFitZoomAndCenter = function (t, e, i, n, s, r) {
      ...
      return (
        d--,
        (d = o.nearRange(d, s, n)),
        { zoom: d, center: i.fromPointToCoord(p), centerPoint: p }
      );
    }),
    (o.nearestPointOnLine = function (t, e, i) {
      var n = { x: i.x - e.x, y: i.y - e.y },
        s = { x: t.x - e.x, y: t.y - e.y },
        r = n.x * n.x + n.y * n.y,
        a = s.x * n.x + s.y * n.y,
  ...
  !(function () {
    for (
      var e = navigator.userAgent.toLowerCase(),
        ...
        h = !1,
        l = ['ipad', 'ipod', 'iphone'],
        c = ['android', 'nokia', 'webos', 'opera mini', 'blackberry'].concat(l),
        u = 0;
      u < c.length;
      u++
    )
    ...
    if (
      ('MacIntel' === navigator.platform &&
        ...
        ((a = 'iOS'), (r = 'ipad')),
      (h = /naver\(inapp; search;/.test(e) || /naver\(inapp; map;/.test(e)),
      (s[i[1]] = !0),
      (s.version = parseFloat(i[2])),
      s.msie)
    ) {
      var p = /trident\/([\w.]+)/.exec(e);
      p && p[1] && (s.trident = parseFloat(p[1])),
    ...
    (function () {
      Dt.mobile
        ? ((m = ['touchstart', 'touchend', 'click']),
          (y = m.concat(['touchmove'])),
          (v = m),
          (GROUND_DOMEVENTS = m),
          (k = 8))
        : ((m = ['click', 'mousedown', 'mouseup', 'contextmenu']),
          (y = m.concat(['mousemove', 'mouseout', 'mouseover'])),
          (v =
            Dt.browser.safari && 5.1 === Dt.browser.version
              ? m.concat(['mouseover', 'mouseout'])
              : m.concat(['mouseenter', 'mouseleave'])),
          (GROUND_DOMEVENTS = m),
          (k = 5),
          Dt.touchablePC &&
            ((k = 8),
            (y = y.concat('touchstart')),
            (v = v.concat('touchstart'))));
    })(),
    (function () {
          ...
          return function (i, n) {
            if (!e[i])
              try {
                ...
                t && ((s.header = ''), (s.msg = '')),
                  Ot.info(o.console.header + i, s.header, s.msg),
                  (e[i] = 1);
              } catch (t) {}
          };
        })(),
  ...
  (zt.getMembers = function (t) {
    var e = {};
    return (
      Ct.forEach(t.prototype, function (t, i) {
        'constructor' !== i && (e[i] = t);
      }),
      e
    );
    ...
    (o.PointBounds.prototype = {
      ...
      intersects: function (t) {
        ...
        var e = this.minX(),
          ...
          s = t.maxX();
        return (
          this.minY() <= t.maxY() && this.maxY() >= t.minY() && e <= s && i >= n
        );
      },
      getCenter: function () {
        ...
        return (
          o.isArray(s)
            ...
            ? r === Nt
              ? ((i = s.lng), (n = s.lat))
              : r === Rt && ((i = s.x), (n = s.y))
            : ((i = 'number' == typeof e ? e : parseFloat(e)),
  ...
  (Nt.prototype.toString = function () {
    ...
    (o.LatLngBounds = function (t, e) {
      ...
      if (
        ...
        !this._sw || (this._ne && !this._ne.isEmpty()))
      ) {
        if (this.maxX() < this.minX() || this.maxY() < this.minY()) {
          var n = Vt.bounds(this.getMin(), this.getMax());
          (this._sw = this._min = n.getMin()),
            (this._ne = this._max = n.getMax());
        }
    ...
    zt(o.LatLngBounds, o.PointBounds, {
      _unbox: function (t, e) {
        ...
        return (
          s
            ? o.isArray(s)
              ? ((i = new Nt(s[1], s[0])), (n = new Nt(s[3], s[2])))
              : r &&
                (r === Vt
                  ? ((i = new Nt(s.south, s.west)),
                    (n = new Nt(s.north, s.east)))
                  : r == Bt &&
                    ((i = new Nt(s.minY, s.minX)),
                    (n = new Nt(s.maxY, s.maxX))))
            : ((i = new Nt(t)), (n = new Nt(e))),
          [i || t, n || e]
        );
      },
      clone: function () {
      ...
      extend: function (t) {
        ...
        return (
          ...
          (s._lat = this._max.y = Math.max(i.y, s.y)),
          (s._lng = this._max.x = Math.max(i.x, s.x)),
      ...
      union: function (t) {
        ...
        return (
          r(this, t) < r(t, this)
            ? ((e = t.minX()), (i = this.maxX()))
            : ((e = this.minX()), (i = t.maxX())),
          new o.LatLngBounds(o.LatLng(n, e), o.LatLng(s, i))
        );
      },
  ...
  o.DOM = {
    ...
    visible: function (t, e) {
      var i = t.style;
      return (
        'boolean' == typeof e && (i.display = e ? '' : 'none'),
        'none' !== i.display
      );
    },
    toggle: function (t) {
    ...
    contains: (function () {
      return x.compareDocumentPosition
        ? function (t, e) {
      ...
      return {
        ...
        getWheelDelta: function (t) {
          if (
            ...
            return null;
          var i = { deltaX: 0, deltaY: 0 };
          return (
            t.deltaY
              ? (i.deltaY = u(-t.deltaY))
              : t.wheelDelta
              ? (i.deltaY = u(t.wheelDelta))
              : t.detail && (i.deltaY = -t.detail),
            t.axis !== e &&
              t.axis === t.HORIZONTAL_AXIS &&
              ((i.deltaX = -1 * i.deltaY), (i.deltaY = 0)),
  ...
  (Ft.css3Styles = {
        ...
        (Ft.transform = function (t, e, i, n, o, r) {
          ...
          (Ft.getTranslate = function (t) {
            var e = r(t),
              i = Rt(0, 0);
            return (
              e.length > 1 && i.add(parseFloat(e[4]), parseFloat(e[5])),
              i.add(Ft.getRawOffset(t)),
              i
            );
          });
      } else
        (Ft.transform = function (t, e, i, n, o) {
          o = o || Rt(0, 0);
          var s = -(o.x * e - o.x),
            r = -(o.y * e - o.y);
          Dt.browser.msie ? ((i *= e), (n *= e)) : ((s /= e), (r /= e)),
            (s += i),
            (r += n),
            (t.style.zoom = e),
            (t.style.left = s + 'px'),
    ...
    kt(Ft, {
      ...
      getSizeWithMargin: function (t) {
        ...
        return (
          (e.width =
            o.toNumber(i.marginLeft) + e.width + o.toNumber(i.marginRight)),
          (e.height =
            o.toNumber(i.marginTop) + e.height + o.toNumber(i.marginBottom)),
          e
        );
      },
      ...
      getOffset: (function () {
        ...
        return Dt.browser.webkit
          ? function (t) {
              for (
                var e = t, i = e.offsetParent, n = 0, o = 0;
                (e = e.parentNode);
      ...
      disableSelection: (function () {
        for (
          var t, e = ['ms', 'webkit', 'Khtml', 'Moz'], i = 0, n = e.length;
          i < n && ((t = e[i] + 'UserSelect'), !Ft.isSupportedStyle(t));
          i++
        )
          t = null;
        return t
      ...
      disableUserDrag: (function () {
        for (
          var t, e = ['ms', 'webkit', 'Khtml', 'Moz'], i = 0, n = e.length;
          i < n && ((t = e[i] + 'UserDrag'), !Ft.isSupportedStyle(t));
          i++
        );
        return function (e) {
          if (t) return void (e.style[t] = 'none');
          e.style.userDrag = 'none';
        };
      })(),
      setOpacity: (function () {
        return Ft.isSupportedStyle('opacity')
          ? function (t, e) {
              t && (t.style.opacity = e);
            }
          : function (t, e) {
    ...
    (Ft.Image = function (t) {
      ...
      (e.DEFAULT_OPTIONS = {
        ...
        (e._img = Ft.createElement('img', X + W + H + K)),
    ...
    (function () {
      function e(t) {
        ...
        return (
          e || ((e = 'NTran-' + ++r), t.setAttribute('data-ntranid', e)), e
        );
      }
      function i(t) {
        var i = e(t),
        ...
        addDOMListener: function (t, e, i, n) {
          ...
          if (r.length > 1) {
            for (var a = [], h = 0, l = r.length; h < l; h++)
              s(r[h]) && a.push(jt.addDOMListener(t, r[h], i, n));
            return a;
          }
          return (
            'mousewheel' !== o || Ut.isMouseWheelSupport || (o = 'wheel'),
            Ut.attach(t, o, i, n),
            { target: t, eventName: o, listener: i }
          );
        },
        removeDOMListener: function (t, i, n) {
          if (t)
            if (o.isArray(t))
              ...
              (i = s(i)),
                'mousewheel' !== i || Ut.isMouseWheelSupport || (i = 'wheel'),
                Ut.detach(t, i, n);
            }
        },
      };
    ...
    (function () {
      o.Math = {
        ...
        getDegrees: function (t, e) {
          ...
          return o.Math.fromRadiansToDegrees(
            Math.atan2(i * r - n * s, i * s + n * r)
          );
        },
        getHorizontalDegrees: function (t, e) {
          var i = { x: t.x, y: e.y },
            n = { x: e.x - i.x, y: e.y - i.y },
      ...
      var t = function (t, e, i, n) {
          ...
          return (l.x <= Math.min(t.x, e.x) ||
            ...
            l.y <= Math.min(t.y, e.y)) &&
            (l.x <= Math.min(i.x, n.x) ||
              l.x >= Math.max(i.x, n.x) ||
              l.y <= Math.min(i.y, n.y) ||
              l.y <= Math.min(i.y, n.y))
            ? null
            : l;
        },
        ...
        n = function (t, e, n, o) {
          ...
          for (s = 0; s < c; s++) {
            ...
            if (Math.min(u.x, p.x) <= e && n <= Math.max(u.x, p.x)) {
              var d, f;
              u instanceof Nt
                ? ((d = Nt(i(u, p, e), e)), (f = Nt(i(u, p, n), n)))
                : ((d = Rt(e, i(u, p, e))), (f = Rt(n, i(u, p, n)))),
                h.push(d),
                l.push(f);
            }
          }
    ...
    (function () {
      o.LocalStorage = {
        ...
        setItem: function (e, i) {
          var n = typeof i;
          'object' === n || Array.isArray(i)
            ? t.localStorage.setItem(e, JSON.stringify(i))
            : ('number' !== n && 'boolean' !== n) ||
              t.localStorage.setItem(e, i.toString()),
            'string' === n && t.localStorage.setItem(e, i);
        },
  ...
  (o.AsyncEventsModel = function (t) {
    ...
    (o.KeyRecognizer = {
      ...
      listenKey: function () {
        ...
        this._keyListeners = [
          ...
          e(i, 'blur', At(this._onMapBlur, this)),
        ];
      },
      ...
      _onMapBlur: function () {
        this._focused = !1;
        var t = this._keyTran;
        t && t.isRunning() && ((this._keyInfo = {}), t.stop());
      },
      ...
      _onCheckFocus: function (t) {
        ...
        this._focused && n.focus({ preventScroll: !0 });
      },
    ...
    (o.MouseRecognizer = {
      ...
      _isMapEvent: function (t) {
        for (
          var e = this.__ie_dtarget__ || t.target, i = this.getTarget(), n = !0;
          e && e !== i;
      ...
      _onDown: function (e) {
        if (
          ...
          this._dragEndTimer &&
            ...
            (this._dragListeners = [
              jt.addDOMListener(i, 'mousemove', At(this._onDrag, this)),
              jt.addDOMListener(i, 'mouseup', At(this._onDragEnd, this)),
              jt.addDOMListener(i, 'dragstart', At(this._resetDrag, this)),
            ]);
        }
      },
      _initDrag: function () {
      ...
      _resetDrag: function (t) {
        this._isMapEvent(t) ||
          -1 === o.getIndexOfElement(['A', 'IMG'], t.target.tagName) ||
          (this._initDrag(), (this._dragStart = !1));
      },
    });
  (o.TouchRecognizer = {
    listenTouch: function () {
      function t(t, e, i, n) {
        return jt.addDOMListener(t, e, i, n || { passive: !1 });
      }
      var e = this.getTarget();
      this._clearTouches(),
        ...
        (this._touchListeners = [
          t(e, 'touchstart', At(this._onTouchStart, this), { passive: !0 }),
    ...
    _getTwoTouches: function (t) {
      ...
      return (
        e &&
          e.length >= 2 &&
          (i = [Rt(e[0].pageX, e[0].pageY), Rt(e[1].pageX, e[1].pageY)]),
        i
      );
    },
    ...
    _processPinch: function (t, e) {
      ...
      this._pinching ||
        ((this._pinching = !0), jt.trigger(this, 'pinchstart', i)),
        jt.trigger(this, 'pinch', i);
    },
    ...
    _pinchChange: function (t) {
      if (2 === t.originalEvent.touches.length) {
        ...
        this._startVec && (t.rotation = o.Math.getDegrees(i, this._startVec)),
          this.get('pinchZoom') &&
            !this._tilting &&
            1 !== t.scale &&
    ...
    _twofingerTap: function () {
      var t = this._startTouches,
        ...
        i = e.pageXY;
      e.clientXY;
      jt.trigger(this, 'twofingertap', { pageX: i.x, pageY: i.y });
    },
    ...
    _twoFingerMove: function (e) {
      ...
      this._pinchChange(i),
        this._clearPinchTimer(),
        (this._pinchEndCallback = At(this._pinchEnd, this, i)),
    ...
    (o.MapUpdater = {
      ...
      _fireEvents: function (t, e) {
        ...
        for (var s = 0; s < n.length; s++)
          (i = n[s]), o.isDefined(t[i]) && this.set(i, t[i], e);
    ...
    zt(
      ...
      [o.MouseRecognizer, o.KeyRecognizer, o.TouchRecognizer],
      {
        ...
        _createPane: function (t, e, i, n, o) {
          ...
          return (
            B && i && s.setAttribute('data-pane-name', i), t.appendChild(s), s
          );
        },
        _prepareDOM: function () {
          ...
          Dt.mobile || (this._mapDiv.tabIndex = 0),
        ...
        addPane: function (t, e) {
          ...
          return (
            o.isNumber(n) || !o.hasValue(n)
              ? ((i = n || this._zIndex++),
                (n = this._createPane(this.get('containerDiv'), i, t)))
    ...
    zt(o.MapModel, o.KVO, [o.MapUpdater, o.ZoomScaleChecker], {
      padding_changed: function (t) {
        ...
        this.set(
          'paddingOffset',
          Rt((i.x - e.x) / 2, (i.y - e.y) / 2).mul(-1, -1)
        ),
          this.getCenter() &&
            this.setProjBounds(
              this.get('size'),
      ...
      initPrimaryData: function (t) {
        ...
        !1 === o.hasValue(n) && (n = -1),
          ...
          i.set(
            'centerPoint',
            i.get('mapSystemProjection').fromCoordToPoint(u)
          ),
      ...
      getBoundsWithMargin: function (t, e, i) {
        if (
          ...
          (e = o.trbl(e)),
          (e = o.trbl_abs(e)),
          (i = o.isDefined(i) ? i : this.get('zoom')),
          o.trbl_isZero(e))
        )
          return t;
        ...
        return (
          ...
          (n = this._fromOffsetToCoordAtZoom(n, i)),
    ...
    zt(o.MapAction, o.KVO, {
      ...
      zoomBy: function (e, i, n) {
        (i = this._eventOrigin_px || i), (e = Math.round(e));
        ...
        var c = this.get('size'),
          ...
          g = f && this._getBufferedBounds(f, 3);
        if (g && !g.hasPoint(h.fromOffsetToCoord(i)))
          (p = this.get('centerPoint').clone()),
            (i = this._mapModel.getCenterPixel());
        else {
          d.sub(c.width / 2, c.height / 2), d.add(u.x, u.y);
          var _ = d.clone();
          h.scaleDown(d, r), h.scaleDown(_, a), p.add(d), p.sub(_);
        }
        return (
          n &&
            (o.isZooming() ||
              ((this._eventOrigin_px = i.clone()),
      ...
      _onChangeZoomingBy: function (t, e) {
        ...
        t < 1
          ? ((t -= 1), (i = this._startScale + 1 + t))
          : (i = this._startScale + t),
          1 !== (i = this._mapModel.getFittableScale(i)) &&
            (this._prevPinch && (i < 0.1 && (i = 0.1), i > 16 && (i = 16)),
      ...
      morph: function (t, i, n) {
        ...
        if (
          (o.hasValue(i) && (i = this._mapModel.getValidZoom(i - r)),
          (s = i - r),
          i === e || 0 === s)
        )
        ...
        l < 1 && (a.easing = 'eastInCubic'), this.zoomBy(s, f, kt(a, n));
      },
      kineticPan: function (t, e) {
        ...
        if (i) {
          ...
          n.mul(5, 5),
            ...
            i.run({ x: e.x, y: e.y }, { x: a.x, y: a.y }, { duration: r });
        }
      },
      ...
      _onDragEnd: function (t) {
        if (this._down) {
          ...
          0 === t.type.indexOf('touch') && 0 === o.x && 0 === o.y
            ...
            (i = e ? e.clone().sub(o) : Rt(0, 0)),
            this._isMapDragging &&
              (-1 === t.type.indexOf('touch') &&
                this._mapView.toggleHand('open'),
              this.get('disableKineticPan') || (0 === i.x && 0 === i.y)
      ...
      _getBufferedBounds: function (t, e) {
        var i = t.minX(),
          n = t.minY(),
          o = t.maxX(),
          s = t.maxY();
        return Vt(Nt(n - e, i - e), Nt(s + e, o + e));
      },
    }),
    ...
    zt(o.TileIndexArray, o.KVO, {
      ...
      getRotatedIndexes: function () {
        for (
          var t = [], e = this.get('indexes').getLength(), i = 0, n = [];
          i < e;
          i++
        )
          t.push(i);
      ...
      _rotateFire: function (t) {
        for (var e = this.getRotatedIndexes(), i = 0, n = e.length; i < n; i++)
          jt.trigger(this, 'insert_at', e[i], t.getAt(e[i]));
        this._forwardEvents(t);
      },
      tileSize_changed: function (t) {
        (this._tileSize = t),
          (this._baseForExtraTile_px = new o.Point(
            parseInt(t.width * this.BASE_FOR_EXTRA_TILE, 10),
            parseInt(t.height * this.BASE_FOR_EXTRA_TILE, 10)
          ).round());
      },
        ...
        if (this._inited) {
          ...
          this._removeHiddenTiles(e, n),
            ...
            t || o.length === e.getLength()
              ? ((this._basePx.x = i.startX_px), (this._basePx.y = i.startY_px))
              : this._interpolate(i),
            ...
            (this._oldRange = i),
            jt.trigger(this, 'updated', i),
            t && jt.trigger(this, 'resized', i);
        }
      },
      ...
      _removeHiddenTiles: function (t, e) {
        if (!(t.getLength() <= 0)) {
          ...
          for (n = e.length - 1; n >= 0; n--)
            (i = e[n].tileIndex), t.getAt(i) && t.removeAt(i);
        }
      },
      ...
      _getDiffOfTiles: function (t, e) {
        ...
        for (var s = t.startXIndex; s <= t.endXIndex; s++)
          for (
            ...
            r || h
              ? ((i = (s - t.startXIndex) * o + (a - t.startYIndex)),
                n.push({ tileIndex: i, xIndex: s, yIndex: a }))
      ...
      getIndexesRange: function (t, e) {
        ...
        return (
          ...
          0 !== P && ((I.endXIndex += S), (I.endYIndex += S)),
    ...
    zt(o.ZoomEffector, o.KVO, {
      ...
      _hidePane: function (t) {
        ...
        o.forEach(this._panes, function (i, n) {
          t
            ? e.get('ef_' + n.toLowerCase()) || Ft.visible(i, !1)
            : Ft.visible(i, !1);
        });
      },
      _showPane: function (t) {
        ...
        o.forEach(this._panes, function (i, n) {
          t
            ? e.get('ef_' + n.toLowerCase()) || Ft.visible(i, !0)
            : Ft.visible(i, !0);
        });
      },
      clearOverlayPanePosition: function () {
      ...
      _scaleZoomPane: function (t) {
        ...
        if (this.csszoom) {
          ...
          Ft.setScale(e, t, n, !0),
            this.get('ef_overlay') && Ft.setScale(i, t, n, !0);
      ...
      _teardown: function () {
        ...
        Ft.isSupportedCSS3Style('transform') ||
          ...
          Ft.setOffset(e, t),
          this.get('ef_overlay') && Ft.setOffset(i, t),
          (this._tilePane.style.display = '');
      },
      finish: function () {
  ...
  (Yt.prototype = {
      ...
      zt(s, Yt, {
        ...
        fromPointToLatLng: function (e) {
          ...
          return (
            ...
            (s = t(s - Math.PI / 2)),
            o.LatLng(parseFloat(s.toFixed(7)), parseFloat(i.toFixed(7)))
          );
        },
    ...
    zt(o.MapSystemProjection, o.KVO, {
      ...
      fromCoordToPoint: function (t) {
        ...
        return (
          e !== o.EmptyProjection && n.mul(i.width, i.height),
          this._interpolate(n)
        );
      },
      fromPointToCoord: function (t) {
        var e = this.get('projection'),
          ...
          n = t.clone();
        return (
          e !== o.EmptyProjection && n.div(i.width, i.height),
      ...
      _interpolate: function (t) {
        ...
        return (
          this.get('repeatX')
            ? (e.x > r ? (e.x = e.x % r) : e.x < 0 && (e.x = r + (e.x % r)),
              e.y > a ? (e.y = e.y % a) : e.y < 0 && (e.y = a + (e.y % a)))
            : ((e.x = Math.min(Math.max(e.x, 0), r)),
              (e.y = Math.min(Math.max(e.y, 0), r))),
          e
        );
      },
    }),
      ...
      zt(l, Yt, {
        ...
        _fromCoordToPlane: function (e, n) {
          ...
          return 'LATLNG_TO_UTMK' === e
            ? Rt(parseFloat(o.toFixed(1)), parseFloat(r.toFixed(1)))
            : ('UTMK_TO_POINT' === e &&
        ...
        _fromPlaneToCoord: function (t, s) {
          ...
          if (
            ...
            return Rt(parseFloat(r.toFixed(1)), parseFloat(a.toFixed(1)));
        ...
        if ('selectedPaneType' !== t && 'selectedMapType' !== t) {
          ...
          o.KVO.prototype.set.apply(this, arguments),
            ...
            null !== e
              ...
              : i &&
                (jt.trigger(this, 'remove_paneType', t, i),
                jt.trigger(this, 'removeMapType', t, i));
        }
      },
      setSelectedTypeId: function (t) {
        (this._prevId = this._typeId),
          (this._typeId = t),
          o.KVO.prototype.set.apply(this, ['selectedMapType', this.get(t)]),
          o.KVO.prototype.set.apply(this, ['selectedPaneType', this.get(t)]);
      },
    ...
    zt(o.Tile, o.KVO, {
      ...
      load: function (t, e) {
        var i = kt({}, t);
        this.getOffset() || i.offset || (i.offset = Rt(0, 0)),
          this.setValues(i),
          this.show(),
          e && e(),
          this.get('transition')
      ...
      setTileIndex: function (t) {
        var e = t.xIndex,
          i = t.yIndex;
        'x' in t && ((e = t.x), (i = t.y)),
          this.set('tileIndex', { xIndex: e || 0, yIndex: i || 0 });
      },
      disable: function () {
    ...
    zt(o.TilePool, o.KVO, {
      ...
      remove: function (t) {
        var e, i;
        t instanceof o.Tile
          ? ((e = t), (i = this.fromIndexToKey(e.getTileIndex())))
          : ((i = this.fromIndexToKey(t)), (e = this._tiles[i])),
          e &&
            (e.destroy(),
            (e = null),
    ...
    (o.AbstractMapType.prototype = {
      ...
      setMapTypeOptions: function (t) {
        ...
        (n = o.isNumber(n) ? Zt(n, n) : o.box(n, Zt)),
          (i.tileSize = n),
          (i.minZoom = (o.isDefined(t.minZoom) ? t.minZoom : t.maxZoom) || 0),
          (i.maxZoom = t.maxZoom || 0),
          (i.name = t.name || 'unknown'),
          (i.projection = t.projection || o.EmptyProjection),
          (i.repeatX = t.repeatX || !1),
          (i.provider = t.provider || e),
          (i.vendor = t.vendor || e),
          (i.darktheme = t.darktheme || !1),
          (i.uid = t.uid),
          i.uid || (q++, (i.uid = 'unknown:unknown-' + q)),
          (i._options = t);
      },
    ...
    zt(o.ImageMapType, o.AbstractMapType, {
      ...
      getTileUrls: function (t, e, i) {
        ...
        return (
          this.repeatX && (t %= a) < 0 && (t += a),
          (!this.repeatX && (t < 0 || t >= a)) || e < 0 || e >= a
            ? (n = s.TRANSPARENT_URL || U)
            : s.getTileUrl
            ? (n = s.getTileUrl(t, e, i))
            : s.tileSet && (n = this._getUrlFromTileSet({ x: t, y: e, z: i })),
  ...
  (o.CanvasMapType = function (t) {
    ...
    zt(o.CanvasMapType, o.AbstractMapType, {
      ...
      getTileData: function (t, e, i) {
        var n,
          o = this._getTileCount(i),
          s = this._options;
        return (
          this.repeatX && (t %= o) < 0 && (t += o),
          (!this.repeatX && (t < 0 || t >= o)) || e < 0 || e >= o
            ? (n = null)
            : s.getTileData && (n = s.getTileData(t, e, i)),
          n
        );
      },
      getTile: function (t, e, i) {
  ...
  (Kt.prototype = {
    ...
    getTileUrl: function (t, e, i) {
      ...
      var n, s;
      i < 1
        ? ((n = Math.pow(2, i + 1) - 1), (s = n))
        : ((n = 3 * Math.pow(2, i - 1)), (s = n - 1)),
    ...
    _xyToServerNum: function (t, e) {
      return this.serverCount <= 1
        ? ''
        : parseInt(((t + e) % this.serverCount) + 1, 10);
    },
        ...
        e = {
          ...
          satellite: [
            ...
            },
            {
              title: ' /\uad6d\ud1a0\uc9c0\ub9ac\uc815\ubcf4\uc6d0',
              bounds: [
                Vt(Nt(36.9604682, 126.7654746), Nt(38.1834428, 127.8062689)),
                Vt(Nt(33.1940984, 126.1631646), Nt(33.5666617, 126.9448023)),
                Vt(Nt(34.2894075, 126.1667903), Nt(36.157058, 127.916409)),
                Vt(Nt(37.0338716, 127.1017059), Nt(38.6097027, 129.4009515)),
                Vt(Nt(34.7636795, 127.5739401), Nt(37.1422076, 129.6170151)),
                Vt(Nt(37.2844933, 130.6524052), Nt(37.6950155, 131.0788897)),
                Vt(Nt(35.9625217, 125.5567761), Nt(37.2537581, 128.6557701)),
              ],
            },
          ],
          traffic: [
  ...
  (Ht.prototype = {
    ...
    getTileUrl: function (t, e, i) {
      ...
      for (f = 0, g = u.length; f < g; f++)
        _.push(this.toTileUrl(t, e, i, a, h, l[f], c, u[f], d, p));
      return _;
    },
    toTileUrl: function (t, e, i, n, o, s, r, a, h, l) {
      return (
        [this._getLocation(t, e), n, o, i, t, e].join('/') +
        r +
        '.' +
        s +
        this._getQuery(a, l)
    ...
    _getRtsVersionQuery: function () {
      ...
      return (e = n.map.layers.traffic)
        ? ((i = e.registry.traffic.getOptions()),
          (t = i && i.timeStamp ? i.timeStamp : ''),
          '' !== t ? 'rtsVersion=' + t : '')
      ...
      kt(Ht, {
        getMapTypes: function (t) {
          var e = {
            ...
            i = new o.MapTypeRegistry(e);
          return (
            (i.VENDOR = '\xa9 NAVER Corp.'),
            (i.uid = 'naver:imagemap:default'),
            i
          );
        },
        getWorldMap: function (e) {
        ...
        sortOverlay: function (t) {
          ...
          return (
            ...
            a
              ? ((i[Mt] = ''), (i[Et] = ''))
              : s && r && ((i[Mt] = ''), (i[Et] = ''), (i[St] = 'ts')),
            i.filter(this.emptyValueFilter).join('.')
          );
        },
    ...
    (o.LabelLayer = function (t, e, i) {
      var n = kt({ zIndex: 99, overlayMap: !0, forceOverlayToMapType: !0 }, i);
      o.Layer.apply(this, ['label', Ht.getNormalLabelLayer(), n]);
    }),
    zt(o.LabelLayer, o.Layer),
    (o.BicycleLayer = function (t) {
      var e = kt({ zIndex: 3, overlayMap: !0, forceOverlayToMapType: !0 }, t);
      o.Layer.apply(this, ['bicycle', Ht.getBicycleLayer(), e]);
    }),
    zt(o.BicycleLayer, o.Layer),
    (o.CadastralLayer = function (t) {
      var e = kt({ zIndex: 1, overlayMap: !1, forceOverlayToMapType: !0 }, t);
      o.Layer.apply(this, ['cadastral', Ht.getCadastralLayer(), e]);
    }),
      ...
      set: function (t, e) {
        ...
        o.KVO.prototype.set.apply(this, arguments),
          ...
          null !== e
            ...
            : i && jt.trigger(this, 'removeLayer', t);
      },
    ...
    (o.StreetLayer = function (t) {
      ...
      o.Layer.apply(this, ['street', Ht.getStreetLayer(), e]);
    }),
    zt(o.StreetLayer, o.Layer),
    (o.TrafficLayer = function (t) {
      var e = kt(
        { zIndex: 2, overlayMap: !0, interval: 3e5, forceOverlayToMapType: !0 },
        t
      );
      o.Layer.apply(this, ['traffic', Ht.getTrafficLayer(), e]);
    }),
    zt(o.TrafficLayer, o.Layer, {
      _addToMap: function (t) {
        var e = this;
        e._rtsVersionLoader || (e._rtsVersionLoader = new ie()),
    ...
    (o.MapOptions = function (t, e) {
      (e = e || {}), (this.map = t), (U = e.blankTileImage || F);
      var i = [Lt.SATELLITE, Lt.HYBRID],
        n = i.indexOf(e && e.mapTypeId) > -1;
      if (
        (kt(this, {
          gl: !1,
          background: n ? '#111213' : '#f8f9fa',
          tileSpare: 0,
          pixelRatio: N,
        ...
        (e.logoControl = e.logoControl || !0),
        'mapTypes' in e ||
          (e.mapTypes = Ht.getMapTypes({
            map: t,
        ...
        if (!(e.center instanceof o.Point)) {
          var s = e.mapTypes.get(e.mapTypeId || this.mapTypeId).projection;
          ['UTMK', 'UTMK_NAVER', 'EPSG:3857'].indexOf(s.name) > -1
      ...
      !e.zoomOrigin ||
        ...
        !e.size || e.size instanceof o.Size || (e.size = o.box(e.size, o.Size)),
    ...
    zt(o.MapOptions, o.KVO, {
      ...
      updateSilently: function (t, e) {
        var i = this.get(t);
        i instanceof Rt || i instanceof Bt || i instanceof Zt
          ? !1 === i.equals(e) && this.set(t, e, !0)
          : 'object' != typeof i
          ? i !== e && this.set(t, e, !0)
          : this.set(t, e, !0);
      },
      ...
      limitMaxBounds: function (t) {
        ...
        var e = o.LatLngBounds(
          { lng: 124.2694863, lat: 32.122953 },
          { lng: 131.969556, lat: 38.6152377 }
        );
      ...
      destroy: function () {
        for (
          var t = this.get('mapTypes'), e = t.getTypeIds(), i = 0, n = e.length;
          i < n;
          i += 1
        ) {
          t.get(e[i]).map = null;
    ...
    (o.Map = function (t, e) {
      if ((_(this), !t))
        throw new Error(
          'Invalid type: "mapDiv" must be a String or HTMLElement.'
        );
      if (o.isString(t) && !n.getElementById(t))
        throw new Error('Container ' + t + ' not found.');
      (this.mapTypeId = 'normal'),
        (this._pendingOptions = []),
        (this.isReady = !1),
        this._initUserLanguage(e);
      var i = this._initMapOptions(e);
      this._loadMeta(),
        (this.id = 'nmap-' + o.guid()),
        (this.__WILL_REDRAW = !1),
        (this._mapModel = new o.MapModel(i)),
    ...
    zt(o.Map, o.KVO, {
      initMap: function (t) {
        this._updateMapTypeOptions(),
          ...
          2 !== this.get('renderMode') &&
            (this.trigger('init_stylemap', t),
            this.trigger('init', t),
            o.useGL() && this._triggerIdle());
      },
      ...
      panToBounds: function (t, e, i) {
        (t = o.box(t)),
          this.__reserveMove('panToBounds', [t, e, i]) ||
      ...
      morph: function (t, e, i) {
        (t = o.box(t)),
          this._stopTransition(),
          this.__reserveMove('morph', [t, e, i]) ||
            this._mapAction.morph(t, e, i);
      },
      setTilt: function (t) {
      ...
      setOptions: function (t) {
        ...
        if ('string' == typeof t) {
          var i = t,
            n = arguments[1];
          'padding' === i && (n = kt(e.get('padding'), n)),
            e.setRefinedOption(i, n);
        } else
          o.forEach(
            t,
            At(function (t, e) {
      ...
      _initMinMaxZoom: function (t, e) {
        var i = t.get('minZoom'),
          n = t.limitMinZoom(i),
          s = t.get('maxZoom');
        null !== n && t.set('userMinZoom', n),
          null !== s && t.set('userMaxZoom', s),
          e &&
            t.isDefaultMapType() &&
            i &&
            i < 6 &&
      ...
      _listenMapOptions: function (t) {
        ...
        jt.once(this, 'init', function () {
          if (!e.controlPositioner) return void jt.once(e, 'assemble', i);
          i();
        }),
          jt.once(this, 'assemble', function () {
            e.__listen__('_mapOptionsListeners', [
              jt.addListener(t, 'minZoom_changed', function (i) {
      ...
      _initMapView: function (t, e) {
        ...
        (this._resizeMapListener = jt.addListener(
          ...
          n
            ? i.setSize(n)
            : (e.set('size', i.getSize(), !0), this._listenResize()),
          (this._mapView = i);
      },
      ...
      _changeRegistry: function (t) {
        ...
        (this.mapTypes = t),
          ...
          i && i.getMap() && (i.setMap(null), i.setMap(this));
      },
          ...
          var i = this._mapOptions,
            ...
            o = function (t) {
              n[t]
                ...
                : ((n[t] = new e(i[t + 'Options'])), n[t].setMap(n));
            };
          i[t] && o(t),
            jt.addListener(
              i,
      ...
      _addCopyrightControls: function () {
        var t = this,
          e = this.getPrimitiveProjection(),
          i = this._mapOptions.get('scaleControlOptions'),
          n = i && i.position === b.BOTTOM_LEFT,
          s = n
            ? ['logoControl', 'mapDataControl', 'scaleControl']
            : ['scaleControl', 'logoControl', 'mapDataControl'];
        o.forEach(s, function (i) {
          if (
            ...
            var n = o.capitalize(i);
            t._addInternalControl(i, o[n]);
          }
        });
      },
      ...
      destroy: function (t) {
        ...
        if (((n.innerHTML = ''), i)) {
          (n.style.backgroundImage = 'url("' + Z + '/auth_fail.png")'),
            (n.style.backgroundPosition = 'center center');
          try {
            n.style.backgroundSize = '256px 256px';
          } catch (t) {}
        } else n.style.background = 'none';
        for (var s, r = -1, a = 0, h = o.Map.__instances.length; a < h; a++)
          if (((s = o.Map.__instances[a]), s.id === e.id)) {
            r = a;
            break;
          }
        r > -1 && o.Map.__instances.splice(r, 1);
      },
      _mapType_changed: function (t) {
        ...
        if (t && i) {
          ...
          l &&
            ((l.map = this),
            (h = l.overlayType),
            this.getProjection().set('tileExtra', l.tileExtra || 0)),
      ...
      _getDefaultEventParameters: function (t) {
        ...
        return (
          e && 0 !== t.indexOf('key')
            ? i.push(this._getPointerEvent())
            : t.indexOf('_changed') === t.length - 8 &&
              i.push(this.get(t.replace('_changed', ''))),
          i
        );
      },
    }),
    ...
    (o.CustomControl = function (t, e) {
      ...
      var i = kt({ zIndex: q++ }, this.DEFAULT_OPTIONS);
      this.setOptions(kt({}, i, e || {})),
    ...
    zt(o.CustomControl, o.KVO, {
      _beforeSetMap: It,
      setMap: function (t) {
        if (t && t instanceof naver.maps.Map && (!t.controls || !t.isReady))
          return void o.console.log(
            Pt.TRY_AGAIN_CONTROL.slice(),
            wt.DEFAULT_TWO_LINE.slice()
          );
        var e = this.get('map'),
          i = this.get('position');
      ...
      setPosition: function (t) {
        ...
        'number' != typeof t && (t = n.position),
          e && (this._removeControl(e, i), this._addControl(e, t)),
          this.set('position', t);
      },
      ...
      getOptions: function (t) {
        ...
        return t !== e
          ? this.get(t)
          : (o.forEach(i.DEFAULT_OPTIONS, function (t, e) {
              n[e] = i.get(e);
            }),
            n);
      },
    ...
    (o.CalcControlPosition.prototype = {
          ...
          if (i < t.minHeight) {
            ...
            for (var n, o = 0, s = t.element.childNodes.length; o < s; o++)
              (n = t.element.childNodes[o]) !== e &&
                1 === n.nodeType &&
                (n.style.marginTop = -(n.offsetHeight - i) + 'px');
          } else
      ...
      _alignBottom: function (t) {
        if ('bottom' === t[0]) {
          for (
            var e,
              i = this._getPaneInfo(t),
              n = [],
              s = 1 / 0,
              r = null,
              a = 0,
              h = i.element.childNodes.length;
            a < h;
            a++
          )
            (e = i.element.childNodes[a]), 1 === e.nodeType && n.push(e);
          0 !== n.length &&
            (o.forEach(n, function (t) {
      ...
      _onSizeChanged: function (t) {
        var e = this;
        (e._mapSize = t),
          o.forEach(e._panes, function (t, i) {
    ...
    zt(o.MapTypeControl, o.CustomControl, {
      ...
      _addControl: function (t, e) {
        o.CustomControl.prototype._addControl.apply(this, arguments),
          this._adjustUI(e);
      },
        ...
        if (t) {
          ...
          if (this.get('style') === M.DROPDOWN)
            ...
            (s = this.get('mapTypeElement')),
              ...
              (n.style.color = '#fff'),
              o.forEach(i.subs, function (t, i) {
                var n = t.element.getElementsByTagName('img')[0],
                  o = '-checked',
                  s = '-unchecked';
                e === i && ((s = '-checked'), (o = '-unchecked')),
      ...
      _prepareButton: function (t) {
        var e = this.get('mapTypeIds') || t.getTypeIds(),
          ...
          s = Ft.createElement(
            'ul',
            i.replace('position:relative', 'position:absolute') +
              'left:0;width:100%;'
          );
      ...
      _addMapTypeButton: function (t, e) {
        ...
        if (h && h !== t) {
          (h = this._getParentMapTypeId(e)),
            (l = Ft.createElement('li', i.replace('float:left;', '')));
      ...
      _prepareDropdown: function (t) {
        ...
        (a.innerHTML =
          ...
          (a.href = '#'),
          (a.title = '\uc9c0\ub3c4 \uc720\ud615 \ubcc0\uacbd'),
          (a.onclick = At(this._preventLink, this)),
          s.appendChild(a),
      ...
      _removeMapTypeList: function (t, e) {
        ...
        Ft.removeElement(i.listElement),
          (i = null),
      ...
      _onOutListItem: function (t) {
        var e = Ut.fix(t),
          i = this._getButtonElement(e.target);
        i &&
          i.__mapTypeId !== this._registry.getSelectedTypeId() &&
  ...
  (o.ZoomControl = function (t) {
    ...
    zt(o.ZoomControl, o.CustomControl, {
      ...
      _prepareDOM: function () {
        var t = function (t, e, i) {
          ...
          r = t(
            ...
            i('in-large-normal.png', 28, 22, '\uc9c0\ub3c4 \ud655\ub300')
          ),
          a = t(
            'div',
          ...
          u = t(
            ...
            i('out-large-normal.png', 28, 22, '\uc9c0\ub3c4 \ucd95\uc18c')
          ),
          p = t(
            'div',
      ...
      _createLegendItem: function (t, e) {
        var i = this.SCALER_GAP,
          ...
          r = e || 1,
          a = (n - 21) * i + 3,
          h = Ft.createElement('img', Y + W + 'width:44px;height:17px;'),
          l = Ft.createElement(
            'span',
            X +
              'font-family:' +
        ...
        return (
          (h.src = Z + '/zoom-legend-left-normal.png'),
          (h.alt = ''),
          (l.innerHTML = s),
          o.appendChild(h),
          o.appendChild(l),
          (o.style.top = a + i * (21 - r) + 'px'),
          { zoom: r, element: o, imgEl: h, textEl: l }
        );
      },
      ...
      _bindDOMEvent: function () {
        ...
        this._domListeners = [
          ...
          s(i, 'mousedown', At(this._onClickZoomOut, this)),
      ...
      mapType_changed: function (t) {
        var e =
          !t || '\xa9 NAVER Corp.' !== t.vendor || t.projection !== o.EPSG3857;
    ...
    zt(o.LogoControl, o.CustomControl, {
      ...
      _createElement: function () {
        var t = Z + '/naver-logo-normal-new.png',
          e = 'display:block;width:45px;height:10px;overflow:hidden;',
          i = Ft.createElement('a', e + 'margin:0 5px 7px 12px;');
        return (
          'A' === i.tagName &&
            ((i.href =
          ...
          (i.innerHTML =
            '<img src="' +
            t +
            '" width="45" height="10" alt="NAVER" style="' +
            e +
    ...
    zt(o.MapDataControl, o.CustomControl, {
      ...
      _layout: function () {
        ...
        Ft.visible(this._viewMoreAnchor, e),
          o.forEach(this._providers, function (t, i) {
            t.setVisible(!e);
          });
      },
          ...
          e.bounds &&
            (o.forEach(e.bounds, function (n) {
              ...
              (o = n instanceof Vt ? Bt.bounds(n.getSW(), n.getNE()) : n),
                (i = e.exclude ? !o.hasBounds(t) : o.intersects(t));
            }),
            Ft.visible(e.el, i),
            Ft.visible(e.cloneEl, i));
        });
      },
      _destroy: function () {
    ...
    (o.ScaleControl = function (t) {
      (this._IMG_SCALE = [
        Z + '/new-scale-normal-l.png',
        Z + '/new-scale-normal-b.png',
        Z + '/new-scale-normal-r.png',
      ]),
        (this._SCALE_SIZE = 50),
        (this._MAX_SCALE_SIZE = 100),
        (this._textEl = null),
        (this._textShadowCss =
          '-1px 0 rgba(255, 255, 255, 0.8), 0 1px rgba(255, 255, 255, 0.8), 1px 0 rgba(255, 255, 255, 0.8), 0 -1px rgba(255, 255, 255, 0.8)'),
        (this.DEFAULT_OPTIONS = { position: b.BOTTOM_RIGHT }),
        o.CustomControl.apply(this, arguments);
    }),
    zt(o.ScaleControl, o.CustomControl, {
      ...
      _update: function () {
        var t,
          ...
          l = h - 6;
        if (
          (o.useGL() && (i += 1), 'UTMK_NAVER' === n.name || 'UTMK' === n.name)
        ) {
          ...
          (t = this._getRoundNum(u)),
            (h = Math.round(this._MAX_SCALE_SIZE * (t / u))),
            (l = h - 6),
            (s.style.width = h + 'px'),
            (r.style.width = l + 'px'),
            (r.width = l);
      ...
      _createElement: function () {
        var t =
            'position:absolute;left:0;bottom:0;z-index:2;display:block;width:3px;height:8px;overflow:hidden;margin:0;padding:0;border:0 none;' +
            W,
          e = 'text-shadow:' + this._textShadowCss + ';',
          i = this._IMG_SCALE,
          n = Ft.createElement(
            'div',
            'position:relative;width:52px;height:14px;margin:0 12px 6px 2px;overflow:hidden;'
          );
        (n.innerHTML = [
          ...
          '<img src="' +
            i[1] +
            '" width="43" height="3" alt="" style="' +
            t
              .replace('h:3px', 'h:43px')
              .replace('t:8px', 't:3px')
              .replace('left:0', 'left:3px;') +
            '" />',
          '<img src="' +
            i[0] +
            '" width="3" height="8" alt="" style="' +
            t +
            '" />',
          '<img src="' +
            i[2] +
      ...
      isSupportedVML: function () {
        if (this.__isSupportedVML === e) {
          ...
          (i.style.behavior = 'url(#default#VML)'),
            (this.__isSupportedVML = !i || 'object' == typeof i.adj);
        }
    ...
    (o.LineUtil = {
      ...
      clipSegment: function (t, e, i, n) {
        var o,
          s,
          r,
          a = n ? this._lastCode : this._getBitCode(t, i),
        ...
        ((o.shapes.CommonShape = {
          ...
          toPathString: function (t) {
            ...
            for (var i = 0, n = t.length; i < n; i++)
              e.push(t[i].x + ',' + t[i].y), 0 === i && e.push('L');
            return e.join(' ');
          },
        }),
      ...
      o.DrawingUtil.isSupportedSVG() &&
        ...
        zt(o.shapes.ShapeSVG, o.shapes.Shape, {
          ...
          _getLineCap: function (t) {
            ...
            return o.getIndexOfElement(i, e) > -1
              ? ('flat' === e && (e = 'butt'), e)
              : null;
          },
        ...
        zt(
          ...
          [o.shapes.CommonShape.circle],
          {
            ...
            _updateShape: function () {
              ...
              this._shapeElement.setAttribute(
                'd',
                ['M', i, n + e, 'A', e, e, 0, 1, 0, i, n + e - 1, 'Z'].join(' ')
              );
            },
            _calcBoundsFromOptions: function () {
              var t = this.options,
        ...
        zt(
          ...
          [o.shapes.CommonShape.closedPath],
          {
            ...
            _updateShape: function (t) {
              for (
                var e, i = [], n = this.options.paths, s = 0, r = n.length;
                s < r;
                s++
              )
      ...
      o.DrawingUtil.isSupportedVML() &&
        ...
        zt(o.shapes.PathVML, o.shapes.ShapeVML, [o.shapes.CommonShape.path], {
          ...
          _updateIcons: function (t) {
            ...
            this._shapeElement.getElementsByTagName('stroke')[0][i] =
              n[t[e] - 1] || 'none';
          },
          _updateShape: function (t) {
    ...
    zt(o.OverlayView, o.KVO, {
        ...
        if (this.get('ef_overlay'))
          if (this.scale) this.scale(t);
            ...
            (this._isEffectCustomOverlay = !0),
              Ft.setScale(e, 1 / t, { x: i.x, y: i.y }, !0);
          }
      },
      _onRedraw: function () {
        this._isAdded &&
      ...
      toFeature: function () {
        ...
        var t = this.toGeometry(),
          e = { type: rt, geometry: t, properties: {} };
        return (
          o.forEach(t.mantle_properties, function (t, i) {
            e.properties[i] = t;
          }),
          e
        );
        ...
        if (e)
          if (t) {
            ...
            this._effectListener = [
              ...
              jt.addListener(i, 'zoomstart', At(this._onEffectStart, this)),
              jt.addListener(i, 'scale', At(this._onScale, this)),
            ];
          } else
      ...
      update: function (t, e) {
        ...
        this._manager
          ? (new Ft.Image({
            ...
            this._manager.setHandler({ onload: i, onerror: n }))
    ...
    (o.MarkerAnimation = {
      _animation_changed: function () {
        if (!this._trans) {
          ...
          this._trans = { drop: t, bounceUp: e, bounceDown: i };
        }
        this.draw();
      },
    ...
    (o.MarkerDraggble = {
      ...
      _disableDrag: function () {
        this.removeListener(this._dragReadyListener),
          ...
          this._dragStarted &&
            ...
            this._prevCoord &&
              (this.set('position', this._prevCoord), (this._prevCoord = null)),
            this._prevCursor &&
              (this.set('cursor', this._prevCursor), (this._prevCursor = null)),
            (this._dragReady = null)),
          this._cleanUp();
      },
      ...
      _detectDirection: function (t) {
        ...
        (e[39] = h),
          ...
          !n &&
            (h || l || c || u) &&
            i.run({ weight: 1 }, { weight: 40 }, { infinity: !0 }),
          !n || h || l || c || u || i.stop();
      },
      _getXFactor: function () {
        var t = 0,
    ...
    zt(o.Marker, o.OverlayView, [o.MarkerAnimation, o.MarkerDraggble], {
      ...
      _icon_changed: function (t) {
        ...
        if (!o.equals(e, this._beforeBoxedIcon)) {
          if (
            ...
            return (
              Ft.setOffset(this._icon.getElement(), i),
      ...
      _icon_loaded: function () {
        this._icon.type === Q.html
          ...
          this._updateGL(),
          jt.trigger(this, 'icon_loaded', this);
      },
      draw: function () {
        if (
          this.map &&
          ...
          i && i instanceof Rt && i.round(),
            ...
            this.animation
              ...
              : Ft.setOffsetWithAnchor(this._wrapper, i, this._icon.anchor),
      ...
      _updateAccessibility: function () {
        this._mask.getElementsByTagName('area')[0].alt =
          '\ub9c8\ucee4\uc758 \uacbd\uc704\ub3c4\ub294 ' +
      ...
      _addListener: function (t) {
        if (t && (this.clickable || this.draggable))
          for (var e, i = 0, n = v.length; i < n; i++)
            (e = v[i]),
          ...
          (e = o.Agent.mobile
            ? function (t, e) {
                ...
                switch (t) {
                  ...
                  case 'touchend':
                    a &&
                      ((r = i.__ct__ ? o.now() - i.__ct__ : 250),
                      (s = r < 250 && i._getSingleClickType(e)));
                }
                return [n || t, s];
              }
            : function (t, e) {
                ...
                switch (t) {
                  ...
                  case 'mouseout':
                    ...
                    break;
                  case 'mousedown':
                    i.__dp__ = { x: e.pageX, y: e.pageY };
                    break;
                  case 'click':
                    if (a) return;
                    r =
                      o.Math.distance(i.__dp__, { x: e.pageX, y: e.pageY }) < 4
                        ? i._getSingleClickType(e)
                        : null;
                    break;
                  case 'mouseup':
    ...
    o.forEach(
      ...
      function (t) {
        var e = o.capitalize(t),
          i = 'set' + e,
          n = 'get' + e;
        o.Marker.prototype[i] ||
          (o.Marker.prototype[i] = function () {
    ...
    zt(o.InfoWindow, o.OverlayView, {
      ...
      setOptions: function (t) {
        var e = this,
          i = function (t, i) {
            'position' === t && (i = o.box(i)),
              'anchorSize' === t && (i = o.box(i, o.Size)),
              'pixelOffset' === t && (i = o.box(i, o.Point)),
              e.set(t, i);
          };
        if ('string' == typeof t) {
          var n = t,
        ...
        if (this.getMap()) {
          ...
          if (!t.getMapAction().isTranRunning()) {
            var e = t.getMapModel(),
              ...
              c = this.get('autoPanPadding');
            l.left && !l.right
              ? (a.x += h.left - c.x)
              : !l.left && l.right && (a.x += h.right - o.width + c.x),
              l.top && !l.bottom
                ? (a.y += h.top - c.y)
                : !l.top && l.bottom && (a.y += h.bottom - o.height + c.y),
              (0 === a.x && 0 === a.y) ||
                (a.y > 0 && (a.y += this._iconAnchor.y),
                n.add(a),
                t.panTo(i.fromOffsetToCoord(n), { duration: 200 }));
          }
        }
      },
      ...
      onAdd: function () {
        if (this.getMap()) {
          var t = this.getMap(),
            ...
            i = this.getElement(t);
          (i.style.zIndex = o.toNumber(this.get('zIndex'))),
            t.closeInfoWindow(),
      ...
      scale: function (t) {
        if (this.get('ef_floatpane')) {
          var e = this.getElement(),
            i = this.getBoundary();
          Ft.setScale(e, 1 / t, { x: i.w / 2, y: i.h }, !0);
        }
      },
      resize: function () {
        if (this.getMap()) {
    ...
    (o.GroundOverlay = function (t, e, i) {
      (this.DEFAULT_OPTIONS = { clickable: !0, map: null, opacity: 1 }),
        ...
        this._prepareDOM(),
        this._setOptions(kt({}, this.DEFAULT_OPTIONS, i)),
        this._initEvent();
    }),
    zt(o.GroundOverlay, o.OverlayView, {
      ...
      _initEvent: function () {
        var t = this._wrapper,
          e = this;
        t &&
          o.forEach(GROUND_DOMEVENTS, function (i) {
      ...
      setUrl: function (t) {
        this._img && ((this._img.src = t), this.draw());
      },
      onAdd: function () {
        var t = this.getMap();
        t &&
    ...
    zt(o.AbstractShapeOverlay, o.OverlayView, [o.CalcShapeDrawingPixelBounds], {
      _initEvent: function () {
        ...
        if (t)
          for (var e, i = 0, n = y.length; i < n; i++)
            (e = y[i]), jt.addDOMListener(t, e, this._getListener(e));
      },
      _getPointerEvent: function (t) {
        if (t) {
          var e = t.pos(),
                ...
                switch (t) {
                  ...
                  case 'click':
                    Dt.browser.msie && (s = 'mouseup'),
                      (a =
                        o.Math.distance(i.__dp__, { x: e.pageX, y: e.pageY }) <
                        4
                          ? i._getSingleClickType(e)
                          : null);
                    break;
      ...
      draw: function () {
        if (
          this.getMap() &&
          (this._draw(), this.get(this._getZoomEffectName()))
        ) {
          var t = this.getElement(),
            e = this.strokeWeight;
      ...
      onAdd: function () {
        if (this.getMap() && this._shape.element) {
          var t = this._getPaneName(),
            e = this._getZoomEffectName(),
            i = this.getPanes()[t],
            n = this.getMap().getMapAction();
          i.appendChild(this._shape.element),
            (this.__added = !0),
            this.get(e) &&
      ...
      onRemove: function () {
        if (this.getMap() && this._shape.element && this.__added) {
          var t = this._getPaneName();
          this.getPanes()[t].removeChild(this._shape.element),
            jt.removeListener(this._clickableListener),
      ...
      scale: function (t) {
        if (this.get(this._getZoomEffectName()) && this.strokeWeight) {
          var e = this.getElement(),
            i = this.strokeWeight;
      ...
      _getPaneName: function () {
        var t = this.get('pane');
        return ['overlayImage', 'floatPane'].indexOf(t) > -1
          ? t
          : 'overlayLayer';
      },
      _getZoomEffectName: function () {
        return 'ef_' + this._getPaneName().toLowerCase().trim();
      },
    }),
    ...
    zt(o.Polyline, o.AbstractShapeOverlay, {
      ...
      _project: function (t) {
        ...
        return (
          ...
          { path: i, minBoundPoint: Rt(n, o), maxBoundPoint: Rt(s, r) }
        );
      },
    ...
    zt(o.Polygon, o.AbstractShapeOverlay, {
      ...
      _project: function (t) {
        ...
        return (
          ...
          a || (i = []),
          { paths: i, minBoundPoint: Rt(n, o), maxBoundPoint: Rt(s, r) }
        );
      },
      ...
      toGeometry: function () {
        var t = o.DataUtil.fromPolygonArrayToCoordinates([this.getPaths()])[0];
        return (
          o.forEach(t, function (t) {
            var e = t.length,
              i = new Nt(t[0]),
              n = new Nt(t[e - 1]);
            i.equals(n) || t.push(t[0]);
          }),
          {
            type: nt,
            coordinates: t,
    ...
    zt(o.Rectangle, o.AbstractShapeOverlay, {
      setBounds: function (t) {
        ...
        var e = t.getMin(),
          i = t.getMax();
        (t = t instanceof Vt ? Vt.bounds(e, i) : Bt.bounds(e, i)),
          this.set('bounds', t),
          this.draw();
      },
      getBounds: function () {
    ...
    (o.ConverterUtil = {
      ...
      parseColor: function (t) {
        ...
        return 0 === n.length || (o.push('#' + n), isNaN(e))
          ? o[0]
          : (o.push(e), o);
      },
    });
  ...
  !(function () {
    ...
    function a(t, e, i) {
      var n = { type: rt, geometry: { type: t, coordinates: e } };
      return (
        i &&
          (i.bypassStyle && (n.properties = i.bypassStyle),
          i.mantleStyle &&
            ((n.geometry.mantle_properties = i.mantleStyle),
    ...
    function h(t) {
      var i = r(t),
        n = e(t),
        o = { type: rt, geometry: { type: et, coordinates: i } };
    ...
    (function () {
      ...
      function s(t, e) {
        ...
        return (
          i('name', Jt.getValueByTagName(t, 'name'), a),
          i('address', Jt.getValueByTagName(t, 'address'), a),
          i('description', Jt.getValueByTagName(t, 'description'), a),
          o.isEmptyObject(h) ||
            o.forEach(s, function (t) {
          ...
          {
            type: rt,
            geometry: 1 === s.length ? s[0] : { type: st, geometries: s },
            properties: a,
          }
        );
      }
            ...
            s &&
              ...
              o.forEach(s, function (i) {
                ...
                switch (n) {
                  case et:
                    (h = 'Marker'),
                      (s = t(Jt.getValueByTagName(i, 'coordinates')));
                    break;
                  case it:
                    (h = 'Polyline'),
                      (s = e(Jt.getValueByTagName(i, 'coordinates')));
                    break;
                  case nt:
                    h = 'Polygon';
                    ...
                    (s = []),
                      l &&
                        ((u = Jt.getOneElementByTagName(l, 'LinearRing')),
                        s.push(e(Jt.getValueByTagName(u, 'coordinates')))),
                      o.forEach(c, function (t) {
                        (u = Jt.getOneElementByTagName(t, 'LinearRing')),
                          s.push(e(Jt.getValueByTagName(u, 'coordinates')));
                      });
                    break;
                  case 'gx:Track':
      ...
      function h(t) {
        var e = Jt.getValueByTagName(t, 'color'),
          i =
            (Jt.getElementsByTagName(t, 'fill'),
            Jt.getElementsByTagName(t, 'outline'),
            { o: {}, m: {} });
        if (e) {
  ...
  (o.DataLayer = function () {
    ...
    zt(o.DataLayer, o.KVO, {
      ...
      setStyle: function (t) {
        var e = t || null,
          ...
          n = this;
        e &&
          ((i = o.isFunction(e) ? 'function' : 'object'),
          o.isFunction(e) ||
            (e = function () {
              return t;
            })),
    ...
    zt(o.Feature, o.KVO, {
      ...
      setProperty: function (t, e) {
        ...
        -1 === o.getIndexOfElement(i, t) && i.push(t),
        ...
        t
          ...
          : this.forEachOverlay(function (t) {
              ...
              t.getBounds
                ? (i = t.getBounds())
                : t.getPosition &&
                  (i = Bt(t.getPosition().clone(), t.getPosition().clone())),
      ...
      toGeoJson: function () {
        var t = this._propertyList,
          e = this.getRaw(),
          i = { id: this.getId(), type: rt, properties: {}, geometry: {} },
          n = this.getOverlays(),
          s = this;
        return (
          o.forEach(t, function (t) {
    ...
    e.prototype = {
      ...
      exec: function (e) {
        ...
        if (!s.jsContentLoaded) {
          ...
          t.clearTimeout(this._t),
            o.isNumber(e) ? (this._t = t.setTimeout(i, e)) : i();
        }
      },
      boot: function () {
      ...
      load: function (t, e) {
        var i = navigator.connection || {},
          o = 'cellular' === i.type && i.downlinkMax <= 0.115;
      ...
      _async: function (t, e) {
        for (
          var i = t.length,
            ...
            r = n.body || n.getElementsByTagName('head')[0],
            a = 0,
            h = i;
          a < h;
          a++
  ...
  (ee.prototype = {
    ...
    _setDefaultMetadata: function (t) {
      if (!this._isSetDefaultMetadata) {
        for (
          var e, i = this._metadata, n = this._defaultMetadata.split(',');
          (e = n.pop());
  ...
  !(function () {
    if (!t.naver || !t.naver.maps) {
      o.isDefined(t.naver) || (t.naver = {}),
        ...
        delete s.MapTypeId.DARK,
        (t.naver.maps = s);
      var e = jt.addListener(s, '__sbinit', function (t) {
        ht ? (jt.removeListener(e), (e = null)) : _(t);
      });
      B && (s.VERSION = '3.8.2');
    }
  })(),
  ...
  var oe = function (t) {
      ...
      return (
        o.forEach(t.tileTypes, function (i) {
          var n = yt[i] || '';
          e.mapTypes.push(n),
            e.tileTypes.push(i),
            t[i].hasOwnProperty('isFailed') &&
              (e.listOfFailed.push(n), e.listOfTileFailed.push(i));
        }),
        e
      );
    },
    se = function (t) {
      var e = new ee(o.TILE_TYPES, o.GET_STYLE_MAP_METADATA_URLS(!1));
      jt.addListener(e, 'style_map_metadata_load_completed', function (e) {
        if (e.isFailed) {
          if (Xt.available() && Xt.has('__mantle_tile_meta_data'))
            try {
              var i = Xt.getItem('__mantle_tile_meta_data');
              return (_t = i), void t.initMap(oe(i));
            } catch (t) {}
          return void o.console.log(
            '\uc77c\uc2dc\uc801\uc778 \uc11c\ube44\uc2a4 \uc624\ub958\uc785\ub2c8\ub2e4. \uc7a0\uc2dc \ud6c4 \ub2e4\uc2dc \uc2dc\ub3c4\ud574 \uc8fc\uc138\uc694.'
          );
        ...
        (_t = e),
          t.initMap(oe(e)),
          t.trigger('style_map_metadata_load_completed');
        try {
          Xt.available() && Xt.setItem('__mantle_tile_meta_data', e);
        } catch (t) {}
      }),
